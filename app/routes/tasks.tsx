...
const Tasks = () => {
  ...
  const { filteredTasks, setSelectedTask, deleteTask } = useTasks();
  ...
  const actions = [
    ...
    },
    {
      ...
      onClick: (task: Task) => deleteTask(task.id),
    },
  ];

  return (
      <div className="h-full grid grid-cols-[12rem_1fr_12rem] grid-rows-[5rem_1fr]">
        <nav
